...
// `Fulfillment{,Line}Entity` rows here is what registers the `fulfillment` /
// `fulfillment_line` tables at the root connection — `app.module.ts` spreads
// `orderEntities`, so no edit there is needed.
