...
// The service's liveness probe (ADR-044), answered on its existing `notification_events` RPC queue —
...
export class HealthController {
  ...
  public ping(): IHealthPingResult {
    return { status: 'ok', service: AppNameEnum.NOTIFICATION_MICROSERVICE };
  }
}
