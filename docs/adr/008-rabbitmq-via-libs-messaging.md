...
- **Date**: 2026-05-10
- **Status**: Accepted (client-module table extended by [ADR-011](011-notifier-port-and-adapters.md); `MessagingModule` removed by [ADR-043](043-shared-transaction-seam-and-messaging-module-removal.md))
