...
- the transaction seam ([ADR-043](043-shared-transaction-seam-and-messaging-module-removal.md)): `lib-database` → `lib-ddd` passes, `lib-ddd` → `lib-database` fails, and a use case reaches the seam through `lib-ddd`;
