...
This guide builds on the [supplier / vendor party](../product-catalog/supplier-and-vendor.md), which already lives in a
...
- **`FulfillmentLine` at
  ...
  with its own lines.
- **The supplier party** in the [supplier / vendor guide](../product-catalog/supplier-and-vendor.md) — the vendor that
