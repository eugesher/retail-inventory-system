...
owned wholesale by [gift-cards-and-store-credit.md](gift-cards-and-store-credit.md). All this guide adds
...
- The threshold: the moment store credit exists as a tender at all
  ([gift-cards-and-store-credit.md](gift-cards-and-store-credit.md)), making it a *refund destination* is
...
- **The store-credit ledger** ([gift-cards-and-store-credit.md](gift-cards-and-store-credit.md)) — the
...
- **Erasure** follows the ledger's rule, which is [gift-cards-and-store-credit.md](gift-cards-and-store-credit.md)'s
...
[gift-cards-and-store-credit.md](gift-cards-and-store-credit.md) wholesale and reuses the existing refund
