...
[replacement-orders-distinct-entity.md](../order-management/replacement-orders-distinct-entity.md) already define. What makes
...
- **The `Order` aggregate at
  ...
  `Order` (the [replacement-orders-distinct-entity.md](../order-management/replacement-orders-distinct-entity.md) decision):
