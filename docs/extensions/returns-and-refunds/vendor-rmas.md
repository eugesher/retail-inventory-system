...
*in* from the buyer; a vendor RMA walks goods *out* to the party the [supplier-and-vendor.md](../product-catalog/supplier-and-vendor.md)
...
[supplier-and-vendor.md](../product-catalog/supplier-and-vendor.md) and does not re-model it — the party, its contact
...
- The threshold: the first supplier relationship where returning defective stock for credit is worth more
  ...
  ([supplier-and-vendor.md](../product-catalog/supplier-and-vendor.md)) and defective units have non-trivial value.
...
- **The supplier party** ([supplier-and-vendor.md](../product-catalog/supplier-and-vendor.md)) — the destination. A vendor
...
- **Which module owns `VendorReturn`?** It bridges returns (its trigger) and procurement/supplier (its
  ...
  boundary. The [supplier-and-vendor.md](../product-catalog/supplier-and-vendor.md) subsystem is the more natural owner once
  it exists.
...
bounded by inheriting the supplier party from [supplier-and-vendor.md](../product-catalog/supplier-and-vendor.md) rather than
