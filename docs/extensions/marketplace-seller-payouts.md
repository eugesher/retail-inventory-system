...
This guide builds on the [supplier / vendor party](supplier-and-vendor.md) — a marketplace *seller* is
...
- **The seller party** in the [supplier / vendor guide](supplier-and-vendor.md) — the payout
