...
concept is owned by [customer-segments-and-tiers.md](../customer-and-identity/customer-segments-and-tiers.md) — "a tier is a
...
- **The `CustomerSegment` grouping** ([customer-segments-and-tiers.md](../customer-and-identity/customer-segments-and-tiers.md)) —
...
[customer-segments-and-tiers.md](../customer-and-identity/customer-segments-and-tiers.md) and the reduction machinery from
