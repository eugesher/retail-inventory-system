...
[replacement-orders-distinct-entity.md](replacement-orders-distinct-entity.md)) a new `Order` ships the
...
[replacement-orders-distinct-entity.md](replacement-orders-distinct-entity.md) link it rather than
re-argue it:

- **Replacement order** — the customer returns goods; a *new* `Order` ships the substitute. Already
  expressible today, and [replacement-orders-distinct-entity.md](replacement-orders-distinct-entity.md)
...
- **The hard boundary: `returns/` may not import `orders/`.** The outbound substitute is an `Order`, and
  ...
  ([replacement-orders-distinct-entity.md](replacement-orders-distinct-entity.md) attaches on that
