...
├── modules/returns/                           # the RMA bounded context (ADR-032) — the full lifecycle is live (RMQ-only, no gateway route yet)
